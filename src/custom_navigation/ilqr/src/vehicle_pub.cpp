...
int main(int argc, char **argv)
{
    ...
    ros::Publisher vehicle_data_pub = nh.advertise<ilqr::VehicleArray>("vehicle_data", 10); // Replace with your package name
    ...
    while (ros::ok())
    {
        ...
        ilqr::VehicleArray vehicle_array; // Replace with your package name
        ...
        for (size_t i = 0; i < vehicles.size(); ++i)
        {
            ...
            ilqr::Vehicle vehicle; // Replace with your package name
            vehicle.x = x;
            vehicle.y = y;
            vehicle.yaw = yaw;
