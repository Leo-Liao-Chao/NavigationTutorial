...
from nmpc.msg import Experiment
...
if __name__ == '__main__':
    ...
    path = '/home/h301/liaochao/workspace/current/Expriment/CCNMPC/Expriment/Base_CCNMPC/data/V1_sigma/scenario1/'
    file = '1.bag'
    bag_file = path + file
    ...
    # 设置筛选条件
    start_pos = [93, -310]  # 替换为你的起始坐标 (x, y) 93
    end_pos = [133, -300]  # 替换为你的结束坐标 (x, y) 133
    
    # 筛选数据
    filtered_df = data_process(df, start_pos, end_pos,0.06)# 0.06 is the threshhold of follow and avoid obstacle
