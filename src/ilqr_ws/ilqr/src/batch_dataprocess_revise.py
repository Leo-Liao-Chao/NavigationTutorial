...
def data_analysis(data, obstacles):
    ...
    data_time = data["Start Time"]
    min_start_time = data_time.min()
    max_end_time = data_time.max()
    total_time = max_end_time - min_start_time

    traj_distance = 0 
    positions = data["Start Position"]
    positions = positions.reset_index(drop=True)
    for i in range(len(positions) - 1):
        # 提取当前位置和下一个位置的坐标
        pos1 = positions[i][:2]
        pos2 = positions[i + 1][:2]
...
if __name__ == '__main__':
    ...
    path1 = '/home/h301/liaochao/workspace/current/Expriment/Experiment_data_revise/Experiment2/Sigma2/Scenario1/'
    # name = 'CILQR'
    # name = 'CCNMPC'
    # name = 'CILQR_Base'
    name = 'Frenet'
    # # name = 'CCNMPC_one_obstacle'
    # # name = 'CILQR_Base_one_obstacle'
    # # name = 'CILQR_one_obstacle'
    # # name = 'Frenet_one_obstacle'

    # path1 = '/home/h301/liaochao/workspace/current/Expriment/Experiment_data_revise/Experiment3/Sigma3/'
    # # name = 'CILQR-B'
    # # name = 'CILQR-M'
    # name = 'CILQR-ME'
